      ...
      <div className="container mx-auto py-16 px-6">
        ...
        <div className="flex justify-center mt-8">
          <div className="w-full max-w-3xl h-96 bg-gray-300 flex items-center justify-center rounded-lg shadow-lg">
            {startingDemo ? (
              <p className="text-lg font-medium animate-pulse">🚦 Starting Demo...</p>
            ) : isDemoRunning ? (
        ...
        <div className="flex justify-center mt-6">
          <button
            ...
            className={`flex items-center ${
              startingDemo ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
